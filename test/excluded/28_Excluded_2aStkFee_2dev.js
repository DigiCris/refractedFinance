...
contract('No Excluidas', accounts => {
    ...
    context("28- Tx entre dos dir. excluidas, ambas con astkfee positivo y ambas con devfee positivo.", async () => {
        ...
        it("19 - transfer between excluded", async ()=> {
            try{
        ...
        it("20 - Verify balances (error 0 ppm)", async ()=> {
            await checkBalance(owner,'19990053'+'985663836927012925');// 
