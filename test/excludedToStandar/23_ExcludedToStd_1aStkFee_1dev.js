...
contract('No Excluidas', accounts => {
    ...
    context("23- Tx entre una dir. excluida y otra no excluida, una con astkfee en 0% y la otra con astkfee positivo y una con devfee en 0% y la otra con devfee positivo.", async () => {
        ...
        it("16 - Verify balances (error 0 ppm)", async ()=> {
            await checkBalance(owner,'19990049'+'987465624244257940');
            await checkBalance(std1,'1875');
            await checkBalance(std2,'8000');
            await checkBalance(dev,'25'+'000062515589825217'); // acá no cobra pero ya tenía
        });
