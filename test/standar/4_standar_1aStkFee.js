...
contract('No Excluidas', accounts => {
    ...
    context("04- Tx entre dos dir. no excluidas, una con astkfee en 0% y la otra con astkfee positivo y ambas con devfee 0%.", async () => {
        ...
        it("08 - transfer between standars", async ()=> {
            try{
        ...
        it("09 - Verify balances (error 250 ppm)", async ()=> {
            await checkBalance(owner,'19990049'+'975124937812344530');
            await checkBalance(std1,'9900'+'024750061875154687');
