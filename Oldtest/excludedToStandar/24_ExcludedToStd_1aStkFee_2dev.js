...
contract('No Excluidas', accounts => {
    ...
    context("24- Tx entre una dir. excluida y otra no excluida, una con astkfee en 0% y la otra con astkfee positivo y ambas con devfee positivo.", async () => {
        ...
        it("16 - Verify balances (error 0 ppm)", async ()=> {
            ...
            await checkBalance(dev,'45'+'000062515589825217');
        });
